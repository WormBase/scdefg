...
def launch(scvi_tools_model_path,selection_columns,intro_text_html,host,port):
    ...
    if intro_text_html != None:
        with open(intro_text_html, 'r') as file:
    ...
    if selection_columns==None: print('SELECTION COLUMN IS NONE👛👛👛👛👛👛')
    ...
    def receive_submission():
        ...
        defig = go.Figure(
                        data=go.Scatter(
                                ...
                                , layout= {
                                        "title": {"text":
                                                str(jobname) +" <br> dashes mark p = 0.01"
                                                , 'x':0.5
                                                }
